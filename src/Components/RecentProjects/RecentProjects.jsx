        ...
        <div>
            ...
            <div className="md:flex gap-4 justify-start rounded-md items-center">
              ...
              <div className="md:ms-8">
                <div className="md:flex items-center gap-3 mb-4">
                  <h4 className="text-2xl font-semibold text-white">Revive (Team project)</h4>
                ...
                <p className="text-white">Me and my friends develop this project with the help of MERN stack. I spent lots of hours to make this smooth and user friendly also we added animations.</p></div>
            </div>
          ...
          <div className="p-8 mt-4 rounded-md bg-[#1E293B]">
            <div className="md:flex gap-4 justify-start rounded-md items-center">
              ...
              <div className="md:ms-8">
                <div className="md:flex items-center gap-3 mb-4">
                  <h4 className="text-2xl font-semibold text-white">Bistro boss Restaurent</h4>
                  <ul className="flex gap-3 text-center">
                ...
                <p className="text-white">It is an online based restaurant where people can get different types of food and enjoy new dishes. It is a single page application and have payment system through Strip</p></div>
            </div>
          ...
          <div className="p-8 mt-4 rounded-md bg-[#1E293B]">
            <div className="md:flex gap-4 justify-start rounded-md items-center">
              ...
              <div className="md:ms-8">
                <div className="md:flex items-center gap-3 mb-4">
                  <h4 className="text-2xl font-semibold text-white">Tik tak toe</h4>
                  <ul className="flex gap-3 text-center">
                ...
                <p className="text-white">It was a fun project I developed this game by watching a you tube video although I edited more later. During this project I learnt many new things in both JavaScript and Css</p></div>
            </div>
